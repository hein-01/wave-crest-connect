...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Banner Section */}
      <section className="relative h-[300px] md:h-[350px] px-4">
      ...
      {/* Search Bar - Extended below hero section */}
      <section className="relative -mt-8 px-4 pb-8 z-20">
        <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-md p-2 flex items-center space-x-2">
              ...
              {categories.map((category) => (
                <SwiperSlide key={category.value} className="flex items-center justify-center">
                   <button
                     ...
                     className={`w-full h-full text-black font-medium text-xs md:text-sm flex items-center justify-center px-1 md:px-3 ${
          ...
          <Button variant="ghost" className="px-3 py-2 rounded-md flex items-center justify-center hover:bg-transparent">
            <Search className="h-4 w-4" color="#8F6DF5" strokeWidth={3} />
          </Button>
        </div>
      </section>
